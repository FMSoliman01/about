       ...
       <div className="card-body media align-items-center">
             ...
             <div className="card-body body-card">
              <div className="form-group first">
                ...
                <input type="text" className="form-control mb-1" defaultValue="Your  Name" />
              </div>
              ...
              <label htmlFor="gender"  className="gender">Gender:
                    <label  htmlFor="male" className="left2" >Male</label><input className="radio" type="radio" id="male" name="gender" value="male" />
                    <label htmlFor="female" className="left">Female</label><input  className="radio2" type="radio" id="female" name="gender" value="female" checked/ >
                    </label>
                </div>
            </div>
          </div>
